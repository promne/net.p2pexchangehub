...
public class ExternalBankTransactionRequestSucceededEvent {
    ...
    public ExternalBankTransactionRequestSucceededEvent(String bankAccountId, String transactionId, String userAccountId, String userBankAccountId, CurrencyAmount amount) {
        super();
