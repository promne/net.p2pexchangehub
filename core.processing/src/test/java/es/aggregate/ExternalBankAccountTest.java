...
//        annotatedCommandHandler.setRepositoryAccounts(fixture.getRepository());
    ...
    public void testCreateBankAccount() {
         fixture.given()
             .when(new CreateExternalBankAccountCommand("bankAccountId", "currency", "country", "accountNumber", ExternalBankType.TEST))
             .expectEvents(new ExternalBankAccountCreatedEvent("bankAccountId", "currency", "country", "accountNumber", ExternalBankType.TEST));         
    }

    @Test
    public void testSetCredentials() {
        fixture.given(new ExternalBankAccountCreatedEvent("bankAccountId", "currency", "country", "accountNumber", ExternalBankType.TEST))
